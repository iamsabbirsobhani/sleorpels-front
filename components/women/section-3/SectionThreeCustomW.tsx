...
export default function SectionThreeCustomW(props: any) {
  const { data } = props;
  return (
    <>
      <div className=" flex flex-wrap justify-around  lg:flex-row xl:flex-row 2xl:flex-row ">
        {data && data.data.attributes && (
          <ImageTilesW
            imgUrl={data.data.attributes.imgUrlS21C}
            title={"Ripped jeans"}
        ...
        {data && data.data.attributes && (
          <ImageTilesW
            imgUrl={data.data.attributes.imgUrlS22C}
            title={"Golden hour"}
        ...
        {data && data.data.attributes && (
          <ImageTilesW
            imgUrl={data.data.attributes.imgUrlS23C}
            title={"Step styling"}
        ...
        {data && data.data.attributes && (
          <ImageTilesW
            imgUrl={data.data.attributes.imgUrlS24C}
            title={"Olaplex"}
